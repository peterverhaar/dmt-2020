...
<td class="y-axis">
    ...
    <xsl:value-of
      select="count(mods[ originInfo/publisher = $publisher and physicalDescription/extent = '16mo' ])"/>
  ...
  <tr>
    ...
    <td class="y-axis">
      ...
      <xsl:value-of
        select="count(mods[ originInfo/publisher = $publisher and physicalDescription/extent = 'folio' ])"/>
  ...
  <tr>
    ...
    <td class="y-axis">
      ...
      <xsl:value-of
        select="count(mods[ originInfo/publisher = $publisher and physicalDescription/extent = 'octavo' ])"/>
  ...
  <tr>
    ...
    <td class="y-axis">
      ...
      <xsl:value-of
        select="count(mods[ originInfo/publisher = $publisher and physicalDescription/extent = 'quarto' ])"/>
