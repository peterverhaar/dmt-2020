...
<xsl:value-of
    select="count(mods[ originInfo/publisher = $publisher and language/languageTerm = 'grc' ])"/>
</td>
</tr>
...
<xsl:value-of
    select="count(mods[ originInfo/publisher = $publisher and language/languageTerm = 'por' ])"/>
</td>
</tr>
