...
<td class="y-axis">
    ...
    <xsl:value-of
        select="count(mods[ physicalDescription/extent = 'folio' ][ originInfo/publisher = $publisher ])"/>
...
<td class="y-axis">
    ...
    <xsl:value-of
        select="count(mods[ physicalDescription/extent = '16mo' ][ originInfo/publisher = $publisher ])"/>
...
<td class="y-axis">
    ...
    <xsl:value-of
        select="count(mods[ physicalDescription/extent = 'octavo' ][ originInfo/publisher = $publisher ])"/>
...
<td class="y-axis">
    ...
    <xsl:value-of
        select="count(mods[ physicalDescription/extent = 'quarto' ][ originInfo/publisher = $publisher ])"/>
</td>
</tr>
</table>
        </p>
